...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " truepepe-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  truepepe-tx [options] <hex-tx> [commands]  Update hex-encoded truepepe transaction\n" +
            "or:     truepepe-tx [options] -create [commands]   Create hex-encoded truepepe transaction\n" +
            "\n";
