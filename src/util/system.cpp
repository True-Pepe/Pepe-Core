...
const char * const BITCOIN_CONF_FILENAME = "truepepe.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TruePepe";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/TruePepe";
#else
    // Unix-like
    return pathRet / ".truepepe";
#endif
#endif
}
