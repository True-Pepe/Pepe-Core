...
"""Verify that starting truepepe with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start truepepe with -h for help text")
        ...
        self.log.info("Start truepepe with -version for version information")
        ...
        self.log.info("Start truepeped with -fakearg to make sure it does not start")
