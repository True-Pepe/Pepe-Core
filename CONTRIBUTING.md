Contributing to TruePepe Core
============================

The TruePepe Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the TruePepe Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/truepepe-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to truepepe-qt
...
The following applies to code changes to the TruePepe Core project (and related
projects such as libsecp256k1), and is not to be confused with overall TruePepe
Network Protocol consensus changes.

Whether a pull request is merged into TruePepe Core rests with the project merge
...
Patches that change TruePepe consensus rules are considerably more involved than
...
Where a patch set proposes to change the TruePepe consensus, it must have been
...
The project leader is the release manager for each TruePepe Core release.
