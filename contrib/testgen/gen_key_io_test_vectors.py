...
bech32_templates = [
  ...
  ('tpc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('ttpc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttpc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttpc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttpc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('ttpc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttpc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttpc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttpc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rtpc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rtpc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rtpc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rtpc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('ttpc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rtpc',  3,  1, Encoding.BECH32M, False, False, False),
  ('tpc',   15, 41, Encoding.BECH32M, False, False, False),
  ('ttpc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rtpc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('tpc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('ttpc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rtpc',  0, 20, Encoding.BECH32,  False, False, True),
  ('tpc',    0, 20, Encoding.BECH32M, False, False, False),
  ('ttpc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rtpc',  0, 20, Encoding.BECH32M, False, False, False),
  ('tpc',    1, 32, Encoding.BECH32,  False, False, False),
  ('ttpc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rtpc', 16, 20, Encoding.BECH32,  False, False, False),
]
