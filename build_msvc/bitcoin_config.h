...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TruePepe Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TruePepe Core"
...
#define PACKAGE_NAME "TruePepe Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TruePepe Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "truepepe"
