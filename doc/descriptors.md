# Support for Output Descriptors in TruePepe Core

Since TruePepe Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `tpc1...` for mainnet or `ttpc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing TruePepe Core wallets, a convenience function `combo` is
