TruePepe Core version *0.15.1* is now available from:

  <https://download.truepepe.org/truepepe-0.15.1/>
...
A number of changes to the way TruePepe Core deals with peer connections and invalid blocks
